	...
	for (var i = 0; i < setCount; i++) {
        ...
        var makePath = function(ctx) {
            ...
            if (point.name == setName)
				{
			    ctx_.lineTo(this.area.w * point.x + this.area.x, this.area.h * point.y + this.area.y);
				}
            };
			...
			// Magic Customization - TODO Line On Right Required To Hide The Dropping Lines Of Graph
            ctx.closePath();
        };
...
PlotKit.SweetCanvasRenderer.prototype._renderPieChart = function() {
    ...
    context.save();
    context.strokeStyle = Color.blueColor().toRGBString();
    context.lineWidth = 2.0;    
